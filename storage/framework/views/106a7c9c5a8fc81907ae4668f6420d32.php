            ...
            <div class="relative flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-white"><?php echo e($stats['total'] ?? 0); ?></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="relative flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-white"><?php echo e(($stats['by_status']['active'] ?? 0) + ($stats['by_status']['online'] ?? 0)); ?></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="relative flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-white"><?php echo e($stats['workers'] ?? 0); ?></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="relative flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-white"><?php echo e($stats['personas'] ?? 0); ?></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="relative flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-white"><?php echo e($stats['board_members'] ?? 0); ?></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="flex items-center gap-4 flex-wrap">
                <div class="flex gap-1">
                    <button wire:click="switchTab('all')"
                            class="px-4 py-2 rounded-lg text-sm font-semibold transition-all <?php echo e($activeTab === 'all' ? 'bg-gradient-to-r from-purple-600 to-pink-600 text-white shadow-lg' : 'bg-white/5 text-slate-400 hover:bg-white/10'); ?>">
                        All
                    </button>
                    <button wire:click="switchTab('agents')"
                            class="px-4 py-2 rounded-lg text-sm font-semibold transition-all <?php echo e($activeTab === 'agents' || $activeTab === 'workers' ? 'bg-gradient-to-r from-blue-600 to-cyan-600 text-white shadow-lg' : 'bg-white/5 text-slate-400 hover:bg-white/10'); ?>">
                        🤖 Agents
                    </button>
                    <button wire:click="switchTab('personas')"
                            class="px-4 py-2 rounded-lg text-sm font-semibold transition-all <?php echo e($activeTab === 'personas' ? 'bg-gradient-to-r from-purple-600 to-pink-600 text-white shadow-lg' : 'bg-white/5 text-slate-400 hover:bg-white/10'); ?>">
                        🎭 Personas
                    </button>
                    <button wire:click="switchTab('board-members')"
                            class="px-4 py-2 rounded-lg text-sm font-semibold transition-all <?php echo e($activeTab === 'board-members' ? 'bg-gradient-to-r from-amber-600 to-orange-600 text-white shadow-lg' : 'bg-white/5 text-slate-400 hover:bg-white/10'); ?>">
                        👔 Board
                    </button>
                </div>
    ...
    <section>
        <div class="flex items-center gap-3 mb-4">
            ...
            <h2 class="text-sm font-semibold text-slate-300 uppercase tracking-wider">
                <?php echo e($activeTab === 'all' ? 'All Members' : ($activeTab === 'agents' || $activeTab === 'workers' ? 'Agents' : ($activeTab === 'personas' ? 'Personas' : 'Board Members'))); ?>

            </h2>
            <span class="px-2.5 py-0.5 rounded-full bg-white/5 border border-white/10 text-xs text-slate-400"><?php echo e($members->total()); ?> members</span>
        </div>
        ...
        <template x-if="view === 'card'">
            <div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeTab === 'agents' || $activeTab === 'workers' || $activeTab === 'all'): ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php echo $__env->make('livewire.team._member-card-worker', ['member' => $member], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($workers->count() > 0): ?>
                <div class="mb-6">
                    <h3 class="text-lg font-semibold text-white mb-3 flex items-center gap-2">
                        <span>🤖</span> Agents
                    </h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $workers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php echo $__env->make('livewire.team._member-card-worker', ['member' => $member], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($personas->count() > 0): ?>
                <div class="mb-6">
                    <h3 class="text-lg font-semibold text-white mb-3 flex items-center gap-2">
                        <span>🎭</span> Personas
                    </h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $personas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php echo $__env->make('livewire.team._member-card-persona', ['member' => $member], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($boardMembers->count() > 0): ?>
                <div class="mb-6">
                    <h3 class="text-lg font-semibold text-white mb-3 flex items-center gap-2">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $boardMembers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php echo $__env->make('livewire.team._member-card-board', ['member' => $member], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($workers->isEmpty() && $personas->isEmpty() && $boardMembers->isEmpty()): ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeTab === 'personas'): ?>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php echo $__env->make('livewire.team._member-card-persona', ['member' => $member], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeTab === 'board-members'): ?>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php echo $__env->make('livewire.team._member-card-board', ['member' => $member], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    ...
                    <div class="grid grid-cols-12 gap-4 px-6 py-4 border-b border-white/5 hover:bg-slate-800/30 transition-colors">
                        <div class="col-span-4 flex items-center gap-3">
                            <div class="w-10 h-10 rounded-xl bg-gradient-to-br 
                                <?php echo e($member->type === 'workers' ? 'from-blue-500/20 to-cyan-500/20 border-blue-500/30' : 
                            ...
                            <div class="min-w-0">
                                <p class="font-medium text-white truncate"><?php echo e($member->name); ?></p>
                                ...
                                <p class="text-xs text-slate-400 truncate"><?php echo e($member->title); ?></p>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                        </div>
                        <div class="col-span-2 flex items-center">
                            <span class="px-2.5 py-1 rounded-full text-xs font-medium
                                <?php echo e($member->type === 'workers' ? 'bg-blue-500/20 text-blue-400 border border-blue-500/30' : 
                                   ($member->type === 'personas' ? 'bg-purple-500/20 text-purple-400 border border-purple-500/30' : 
                                    'bg-amber-500/20 text-amber-400 border border-amber-500/30')); ?>">
                                <?php echo e($member->type === 'workers' ? 'Agent' : ($member->type === 'personas' ? 'Persona' : 'Board')); ?>

                            </span>
                        </div>
                        <div class="col-span-2 flex items-center">
                            <span class="px-2.5 py-1 rounded-full text-xs font-medium
                                <?php echo e(in_array($member->status, ['active', 'online']) ? 'bg-emerald-500/20 text-emerald-400 border border-emerald-500/30' : 'bg-slate-500/20 text-slate-400 border border-slate-500/30'); ?>">
                                <?php echo e(ucfirst($member->status)); ?>

                            </span>
                        </div>
                        <div class="col-span-2 flex items-center text-sm text-slate-400">
                            <?php echo e($member->model ? ucfirst($member->model) : '—'); ?>
        ...
        <div class="mt-6 flex items-center justify-between">
            <div class="text-sm text-slate-400">
                Showing <?php echo e($members->firstItem() ?? 0); ?> - <?php echo e($members->lastItem() ?? 0); ?> of <?php echo e($members->total()); ?> members
            </div>
            <?php echo e($members->links('pagination::tailwind')); ?>

        </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </section>
</div><?php /**PATH /Users/kobear/.openclaw/workspace/lunaos/resources/views/livewire/team/team-index.blade.php ENDPATH**/ ?>