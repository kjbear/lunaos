    ...
    <div class="justify-between md:flex md:flex-row w-auto md:w-full items-center overflow-y-auto pl-2 pr-2 relative">
        ...
        <div class="flex flex-row justify-center md:justify-start mb-2 md:mb-0 py-1">
            <select id="<?php echo e($uuid); ?>" <?php if(!empty($modelName())): ?> wire:model.live="<?php echo e($modelName()); ?>" <?php endif; ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $perPageValues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
</div><?php /**PATH /Users/kobear/.openclaw/workspace/lunaos/storage/framework/views/6929bb401fcbeeab106552884f99a016.blade.php ENDPATH**/ ?>