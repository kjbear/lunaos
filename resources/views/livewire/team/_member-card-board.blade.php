{{-- Board Member Card Component - Standardized Grid Layout --}}
    ...
    <div class="relative flex items-start gap-4 mb-4">
        ...
        <div class="flex-1 min-w-0">
            <div class="flex items-center gap-2 mb-1">
                ...
                <x-badge class="flex-shrink-0 bg-amber-500/20 text-amber-400 border border-amber-500/30">Board</x-badge>
            </div>
            @if($member->title)
            ...
            <div class="flex items-center gap-2 mt-2">
                ...
                @if($member->model)
                    <x-badge type="warning">{{ ucfirst($member->model) }}</x-badge>
                @endif
            </div>
        </div>
    </div>
