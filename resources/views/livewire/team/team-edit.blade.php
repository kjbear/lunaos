...
<div class="container mx-auto py-8">
    <a href="{{ route('team.show', $member->id) }}" class="text-blue-500 hover:underline mb-4 inline-block">&larr; Back to Member</a>
    
    <h1 class="text-2xl font-bold mb-4">Edit Team Member</h1>
    
    <form action="{{ route('team.update', $member->id) }}" method="POST" class="max-w-2xl">
        @csrf
        @method('PUT')
