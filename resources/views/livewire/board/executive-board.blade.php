<div class="space-y-6">
    ...
    {{-- Main Content - Single Column Layout (No Right Sidebar) --}}
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="bg-slate-900/60 backdrop-blur-sm rounded-2xl border border-white/10 p-6">
            ...
            <div class="relative">
                ...
                <div class="grid grid-cols-2 md:grid-cols-5 gap-4 {{ $loadingStep === 'joining' ? 'opacity-30' : '' }}">
        ...
        {{-- Live Transcript (shown during debate) --}}
